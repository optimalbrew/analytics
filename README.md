...
This project tries to estimate the impact of prices and geographic (long/lat) location on adoption rates. Estimates are obtained sing both linear regression as well as random forests. These preliminary estimates will most definitely exhibit bias due to endogeneity effects. 
